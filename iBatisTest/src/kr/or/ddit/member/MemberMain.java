...
public class MemberMain {
	...
	public MemberMain() {
		memService = new MemberServiceImpl().getInstance();
	}
	...
	/**
	 * 회원정보를 삭제하는 메소드(입력받은 회원 ID를 이용하여 삭제한다.)
	 */
	...
	public void searchMember() {
		// 검색할 회원 ID, 회원 이름, 전화번호, 주소등을 입력하면 입력한 정보만 사용하여 검색하는 기능을 구현하시요
		//주소는 입력한 값이 포함만 되어도 검색되도록 한다
		//입력하지 않을 자료는 엔터킬 다음 입력으로 넘긴다.
