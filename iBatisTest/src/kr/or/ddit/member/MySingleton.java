...
/*
 * singleton패턴	→ 객체 (인스턴스)를 한개 만들어지게 하는 프로그래밍 방법
 * 				외부에서 new 명령을 사용하지 못하게 하고, 동일한 객체(인스턴스)를 반환
 * 				하도록 한다.
 * 
 * -singleton class를 구성하는 방법
 * 1. 자기 자신 class의 참조변수를 멤버 변수로 선언한다.
 ...
 * 		(이 메소드의 이름은 보통 getInstance()으로 지정하고, static으로 지정한다.)
 * 
 */
