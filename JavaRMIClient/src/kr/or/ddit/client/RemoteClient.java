...
/*
 * 클라이언트쪽의 프로젝트에도 서버의 패키지와 같은 구조로 Interface와 VO파일이 
 * 있어야 한다.
 */
public class RemoteClient {
	...
	try {
	    ...
	    files[0] = new File("e:/D_Other/Lyan.png");
	    files[1] = new File("e:/D_Other/1.PNG");
	    ...
	    clientInf.setFiles(fInfo);	//서버의 파일 저장하는 메소드 호출
