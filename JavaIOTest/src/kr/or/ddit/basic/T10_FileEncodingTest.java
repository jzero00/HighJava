 ...
 * 			Writer(문자 기반의 출력용 객체)로 변환하는 객체
 ...
 */
	...
	FileOutputStream fos1 = 
		new FileOutputStream("e:/D_Other/out_utf8.txt");
	FileOutputStream fos2 = 
		new FileOutputStream("e:/D_Other/out_ansi.txt");
	
	/*
	 * OutputStreamWriter은 바이트 출력 스트림에 연결되어
	 * 문자 출력 스트림인 Writer로 변환시키는 보조스트림이다.
	 */
