...
public class Reference {
	 ...
	 * 객체가 서로 같은지를 비교하기 위해 equals()와 hashCode()메소드를 호출한다.
	 * 그래서 객체가 서로 같은지 여부를 결정하려면 구 메소드를 재정의해야 한다.
	 ...
	 * 2. 두 객체가 같으면 equals()메소드를 호출했을때 true를 반환해야 한다.
	 ...
	 * 4. equals()메소드를 override하면 반드시 hashcode()메소드도 override해야한다.
	 ...
	 * 
	 * -hashCode()메소드에서 사용하는 '해싱 알고리즘'에서 서로 다른 객체에 대해 같은 hashcode값을 만들어 낼 수 있다.
	...
	public static void main(String[] args) {
		...
		System.out.println("p1, p2등록후 데이터");
		for(Person p : set) {
