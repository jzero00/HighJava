...
public class T18_BarChartTest extends Application {
	...
	ser1.getData().add(new XYChart.Data<String, Number>("브라질", 2000));
	...
	// new XYChart.Data<>("미국", 11400)
	// );
	ser2.getData().add(new XYChart.Data<String, Number>("호주", 50000));
	ser2.getData().add(new XYChart.Data<String, Number>("브라질", 41000));
	ser2.getData().add(new XYChart.Data<String, Number>("프랑스", 45000));
	ser2.getData().add(new XYChart.Data<String, Number>("이탈리아", 11700));
	ser2.getData().add(new XYChart.Data<String, Number>("미국", 11400));
