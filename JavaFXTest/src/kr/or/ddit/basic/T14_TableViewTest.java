...
public class T14_TableViewTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ObservableList<Member> data = FXCollections.observableArrayList(
				new Member("홍길동", "Gildong", 22, "222-2222", "대전"), new Member("홍길서", "Gilseo", 33, "333-3333", "서울"),
				new Member("홍길남", "Gilnam", 44, "444-4444", "대구"), new Member("홍길북", "Gilbuk", 55, "555-5555", "부산"));
		...
		btnAdd.setOnAction(e -> {
			...
			infoMsg("작업결과", txtKorName.getText() + "님의 정보를 추가했습니다.");
		...
		btnEdit.setOnAction(e -> {
			...
			infoMsg("작업결과", txtKorName.getText() + "님의 정보를 수정했습니다.");
		...
		btnDel.setOnAction(e -> {
			...
			infoMsg("작업결과", txtKorName.getText() + "님의 정보를 삭제했습니다.");
