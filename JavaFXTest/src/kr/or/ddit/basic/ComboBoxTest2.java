...
public class ComboBoxTest2 extends Application {
	...
	ObservableList<MyFriend> list = FXCollections.observableArrayList(
		new MyFriend("a001", "홍길동", "010-1111-1111", "대전"), new MyFriend("b001", "일지매", "010-2222-2222", "광주"),
		new MyFriend("c001", "성춘향", "010-3333-3333", "제주"), new MyFriend("d001", "이몽룡", "010-4444-4444", "포항"),
		new MyFriend("e001", "변학도", "010-5555-5555", "인천"), new MyFriend("f001", "이순신", "010-6666-6666", "부산"));
	combo.setItems(list);
