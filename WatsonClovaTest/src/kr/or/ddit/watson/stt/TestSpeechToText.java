...
public class TestSpeechToText {
	private static final String API_KEY = "Qpx5jI57roSD4a5co3mj9YOLK7QnRK6Y98IcFMxty3Gx";
	private static final String URL = "https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/b9577f7c-2b32-4ec2-8e5f-990c82425ad2";
	...
	private void setOption() {
		...
		try {
			FileInputStream fis = 
					new FileInputStream(
							new File(getClass().getResource("UptownGirl(RadioEdit).mp3").getPath()));
