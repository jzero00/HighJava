 ...
 * 
 * - 보통 객체 자체에 정렬 기능을 넣기 위해서는 Comparable을 구현하도
 * 		정렬 기준을 별도로 구현하고 싶을 때는 Comparator를 구현하야 사용하면 된다.
 * 
 * - Comparable에서는 compareTo()메소드를 구현해야 하고,
 ...
 */
	 ...
	 * Collections.sort()메소드에 인수로 넘겨주면 된다.
	 */
 ...
 * 이 Comparator인터페이스의 compare()라는 메소드를 재정의하여 구현하면 된다.
 */
class Desc implements Comparator<String>{
	 ...
	 * 
	 * - String 객체는 정렬을 위해서 compareTo()메소드가 구현되어 있는데
