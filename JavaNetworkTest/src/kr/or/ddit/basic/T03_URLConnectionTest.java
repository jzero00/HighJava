...
public class T03_URLConnectionTest {
	...
	System.out.println("Connection-Type : " + urlCon.getContentType());
	System.out.println("Content Eincoding : " + urlCon.getContentEncoding());
...
/*
 * 	파일을 읽어오기 위한 스트림 생성
 * 	방법 1 → URLConnection의 getInputStream메소드 이용하기
