...
public class T08_MultiChatServer {
    ...
    //대화방 즉, Map에 저장된 전체 유저에세 메시지를 전송하는 메소드
    ...
    //Inner클래스에서는 부모클래스의 멤버변수들을 직접 사용할 수 있다.ㄴ
	...
	public void run() {
		...
		//한 클라이언트가 보낸 메시지를 다른 모든 클라이언트에세 보내준다.
		while(dis != null) {
